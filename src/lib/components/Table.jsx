...
const Table = ({ first, draggables, input, onSearch, onSort, allUser, page, onPage, Columns, Data, customClass, rows, search, pagination, infiniteScroll, lazy }) => {
    ...
    return <TableLazy lazy={lazy} first={first} draggables={draggables} input={input} onSearch={onSearch} onSort={onSort} allUser={allUser} onPage={onPage} Columns={Columns} Data={Data} customClass={customClass} rows={rows} pagination={pagination} infiniteScroll={infiniteScroll} page={page} />
